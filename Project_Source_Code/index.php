...
<html lang="en">
<head>
<title>Hotel Suite Palace</title>
...
<!--			</div>-->
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@SuitePalace.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+49 67222-44-55</li>
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Hotel  <span>Suite Palace</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>Hotel <span>Suite Palace</span></h4>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">Hotel Suite Palace</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our Suite Palace</h3>
						   <p class="about-para-w3ls">Suite Palace is located in the heart of the Berlin in an extremely characteristic, quite and lively area within short walk distance to all sites and is surrounded by the extraordinary beauty of churches, buildings, shops and monuments. Cellai Hotel is part of a lovingly restored 1800 palace.
                               On entering this charming hotel in Suite Palace, you will immediately sense its special intimate atmosphere that makes you feel like being in your own florentine home.  Each detail has been passionately chosen and each room deserves a visit. Suite Palace style mixes valuable antiques and original artworks with an unexpected eclectic contemporary twist. The entire House recalls the ancient ‘Palazzi’  of times past where young European aristocrats lived while discovering the beauty and the artistic mysteries of Germany.</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+49 65222-44-55</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SuitePalace.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> AlexaderPlatz, Berlin</p>
			...
			<iframe src="https://www.google.com/maps/dir//alexanderplatz/@52.517298,13.4082904,14z/data=!4m8!4m7!1m0!1m5!1m1!1s0x47a84e1edb11286f:0x30fc01c366e4166e!2m2!1d13.413306!2d52.5219814" ></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p>© 2022 Hotel Suite Palace . All Rights Reserved | Design by <a href="index.php">R.K Mamun</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
