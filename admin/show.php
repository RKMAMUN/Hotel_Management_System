...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>Hotel Suite Palace,</p>
				<p>Brunstrasse,<br>Alexanderplatz,<br>Berlin.</p>
				<p>(+94) 65 222 44 55</p>
			</address>
			<span><img alt="" src="assets/img/suite.JPG"></span>
		</header>
		<article>
			<h1></h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- INFO@SuitePalace.COM || Web :- www.suitePalace.com || Phone :- +49 67222-44-55 </p>
			</div>
		</aside>
	</body>
</html>
